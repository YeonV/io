...
try {
  ...
  rendererFileContent += "/* eslint-disable prettier/prettier */\n\n";
  ...
  mainFileContent += `/* eslint-disable prettier/prettier */\n\n`; // Adjust path
  ...
  sharedIdsFileContent += "/* eslint-disable prettier/prettier */\n\n";
