...
const ShortMidi = ({
  ...
  return edit ? (
    <>
      ...
      >
        ...
        >
          ...
          <MenuItem disabled={!midi} value={'midi'}>
            <Piano fontSize={'large'} />{' '}
          </MenuItem>
          <MenuItem disabled value={'rest'}>
            HTTP (rest)
          </MenuItem>
          <MenuItem disabled value={'mqtt'}>
            MQTT
          </MenuItem>
          <MenuItem disabled value={'websocket'}>
            Websocket
          </MenuItem>
          <MenuItem disabled value={'hass'}>
            HomeAssistant
          </MenuItem>
          <MenuItem disabled value={'hass'}>
            Spotify
        ...
        <Stack direction={'row'} gap={2} style={{ flexBasis: '50%' }}>
          ...
          >
            ...
            <MenuItem disabled value={'ledfx-scene'}>
          ...
          {outputType === 'http' && (
            ...
            >
              ...
              <MenuItem disabled value={'PUT'}>
                PUT
              </MenuItem>
              <MenuItem disabled value={'POST'}>
                POST
              </MenuItem>
    ...
    <Stack direction={'row'} gap={2}>
      {keystring.split('+').map((s: any, i: number) => (
        <Button
          key={i}
          variant={
            (s === 'ctrl' && ctrl) ||
