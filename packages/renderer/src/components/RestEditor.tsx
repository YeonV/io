    ...
    return (
        <div>
            ...
            <Dialog onClose={handleClose} open={open} >
                ...
                <DialogContent >
                    <TextField sx={{ width: '100%', bgcolor: '#1e1e1e' }} defaultValue={'UniqueName'} />                    
                    <Stack direction={'row'} sx={{ width: '550px', mt: 2 }}>
                        ...
                        <TextField sx={{ width: '100%', ml: 2, bgcolor: '#1e1e1e' }} value={message} onChange={(e) => setMessage(e.target.value)} />
                    </Stack>
                    ...
                    {(method === 'POST' || method === 'PUT') && <Accordion sx={{ border: '1px solid #555'}}>
                        <AccordionSummary
                            expandIcon={<ToggleOff />}
                            aria-controls="panel1a-content"
                            id="panel1a-header"
