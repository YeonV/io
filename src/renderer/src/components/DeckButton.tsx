...
const DeckButton = ({
  ...
  const [innerFontFamily, _setFontFamily] = useState(fontFamily)
  ...
  const [label, setLabel] = useState(data[rowkey!]?.output.label || data[rowkey!]?.output.data.text)
  const [variant, setVariant] = useState(
    (data[rowkey!]?.output.settings?.variant as 'outlined' | 'text' | 'contained') || 'outlined'
  )
              ...
              <DialogContent>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <TextField value={icon} onChange={(e) => setIcon(e.target.value)} />
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <RadioGroup
                    ...
                    value={variant}
                    onChange={(e) =>
                      setVariant(e.target.value as 'outlined' | 'text' | 'contained')
                    }
                  >
                    <FormControlLabel
                      sx={{
                      ...
                      label={
                        <Button variant="outlined" color="inherit" sx={{ pointerEvents: 'none' }}>
                          <IoIcon name={icon} style={{ marginRight: '10px', color: iconColor }} />
                    ...
                    <FormControlLabel
                      ...
                      label={
                        <Button variant="text" color="inherit" sx={{ pointerEvents: 'none' }}>
                          <IoIcon name={icon} style={{ marginRight: '10px', color: iconColor }} />
                          <Typography variant="button" sx={{ color: textColor }}>
                            Text
                          </Typography>
                  ...
                  onClick={async () => {
                    await fetch(
                      `${location.protocol}//${
                        ...
                        buttonColor
                      )}&iconColor=${encodeURIComponent(iconColor)}&textColor=${encodeURIComponent(
                        textColor
