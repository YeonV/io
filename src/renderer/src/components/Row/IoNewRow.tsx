...
import { InputSelector } from '@/components/Row/InputSelector'
import { OutputSelector } from '@/components/Row/OutputSelector'
...
export const IoNewRow = ({ onComplete }: { onComplete: () => void }) => {
  ...
  const setInput = useStore(useShallow((state) => state.setInput))
